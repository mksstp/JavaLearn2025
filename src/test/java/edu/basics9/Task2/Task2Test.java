...
public class Task2Test {
    ...
    void findingDirectories() {
        // given
        String testString = "src/main/resources/basics9";
        ...
        assertThat(answer.getFirst().getName()).isEqualTo("01");
    }
    ...
    void extensionAndSize() {
        ...
        long size = new File("src/main/resources/basics9/Task2/01/123.txt").length();
        ...
        assertThat(answer.getFirst().getName()).isEqualTo("123.txt");
    }
}
