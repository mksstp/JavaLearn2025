...
class PiFinderTest {
    ...
    void piTestStatistics() {
        ...
        Path filePath = Paths.get("src/main/resources/basics7/piStatistic.txt");
        try {
            ...
            try (FileOutputStream fos = new FileOutputStream("src/main/resources/basics7/piStatistic.txt");
