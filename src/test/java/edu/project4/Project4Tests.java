...
public class Project4Tests {
    ...
    void transformationTest() {
        ...
        //then
        assertEquals(new Point(1.325444263372824, 0.4931505902785393), actualSwirl);
        assertEquals(new Point(0.5, 0.5), actualSphere);
        assertEquals(new Point(0.8414709848078965, 0.8414709848078965), actualSinusoid);
        assertEquals(new Point(0.8579357128540236, 0.8579357128540236), actualPopcorn);
        assertEquals(new Point(0.0, 1.414213562373095), actualHorseShoe);
        assertEquals(new Point(1.2671621313307992, -0.6279332232978174), actualHeart);
        assertEquals(new Point(-0.24097563321246931, -0.06656383551035391), actualDisc);
    }
}
