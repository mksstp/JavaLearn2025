...
import edu.project3.tableRenderers.TableRendererInterface;
import java.io.File;
...
public class LoggerStatisticsMachine {
    ...
    private void renderDayMonthStatistics(TableRendererInterface tableRenderer, FileWriter writer) throws IOException {
    ...
    private void renderResourcesStatistics(TableRendererInterface tableRenderer, Writer writer) throws IOException {
    ...
    private void renderStatusCodesStatistics(TableRendererInterface tableRenderer, Writer writer) throws IOException {
        header = "Коды ответа";
        table = new ArrayList<>();
    ...
    private void renderCommonInfoStatistics(TableRendererInterface tableRenderer, Writer writer) throws IOException {
    ...
    public void renderToFile(String fileName, TableRendererInterface tableRenderer) throws IOException {
